...
import snpCaller.VariantCallingSensitivityDetector;
...
public class GIPS {
        ...
        public GIPSJob gipsRun() throws IOException {
                if(jobType==null) common.CExecutor.stopProgram("Please choose a GIPS tool: [vcs|gips|filter]");
                switch (jobType) {
        ...
        private void runGIPSFull() throws IOException {
                ...
                for (Iterator<String> iterator = this.getSampleParameterBag().getSamplesNamesList().iterator(); iterator.hasNext();) {
                        ...
                        if(mode!=0){
                                ...
                                snpCaller.VariantCallingSensitivityDetector detector;
