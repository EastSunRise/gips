...
//        //this is used in the final step when output the significance
//        public double caculateGenesSignificanceRegardlessAnticipation(int maxSampleNumberHarborMutations, double[] backgroundMutationRate, int geneEffectiveRegionLength) {
//                double[][] geneMutationRate = new double[this.sampleNumber][2];
//                for (int i = 0; i < this.sampleNumber; i++) {
//                        geneMutationRate[i][1] = (double) Math.pow(1 - backgroundMutationRate[i], geneEffectiveRegionLength);//gene has no mutation
//                        geneMutationRate[i][0] = 1 - geneMutationRate[i][1];//0: the probability of mutation
...
//                        }
//                }
//                double probability = 0;//note the significance is accumulation or specific
//                for (int i = this.sampleNumber; i >= maxSampleNumberHarborMutations; i--) {
//                        probability = this.caculateAtSpecificAnticipation(i, sampleNumber, geneMutationRate) + probability;
//                }
//                return probability;
//        }
