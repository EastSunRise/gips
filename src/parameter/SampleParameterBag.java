...
import common.NumeralHandler;
import file.CommonInputFile;
import file.Config;
import genome.effectiveRegion.GenomeEffectiveRegion;
import gips.CandidateGeneBag;
import gips.SampleGeneBag;
import java.io.File;
...
public class SampleParameterBag {
        ...
        public SampleParameterBag() {
                ...
                if (!file.exists()) {
                        file.mkdir();
                        common.CExecutor.println("temporary folder is created");
                }
        }
        ...
        public SampleParameter getSample(String sampleName) {
                ...
                common.CExecutor.stopProgram("Do not find sample: ["+sampleName+"]");
                return null;
        }
...
//           this.caculateFalseDiscoveryRate(candidateGeneBag1.getCandidateGeneNumber());
        ...
        public void setHomozygousGeneDetectingRate(double rate) {
                ...
                common.CExecutor.println(common.CExecutor.getRunningTime()+"If phenotype is recessive:\n"
        ...
        public void setHeterozygousGeneDetectingRate(double rate) {
                ...
                common.CExecutor.println(common.CExecutor.getRunningTime()+"If phenotype is  dominant:\n"
                        + "Chance to report true phenotype-associated genes: " + rate);
        }
        ...
        public void set1Phenoty1GeneValidationHeterozygousGene(double validation) {
                ...
                common.CExecutor.println("Significance of voilating Mendelian phenotype assumption: " + validation);
        }
        ...
        public void addSampleParameter(SampleParameter sampleParameter) {
                if(sampleParameter.isSpecified()&&!sampleParameter.isPassSpecify()){
                        common.CExecutor.stopProgram("["+sampleParameter.getName() + "] SPECIFY_BVF, SPECIFY_HOMO_VDS and SPECIFY_HETERO_VDS parameters should be specified together");
                }
                if(sampleParameter.isSpecified()&&sampleParameter.isPassSpecify()){
