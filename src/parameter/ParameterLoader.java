        ...
        public SampleParameterBag loadSampleSpecificParameter(String path){
                ...
                while((line=parameterFile.readLine())!=null){
                        ...
                        if(!sampleNames.add(line.trim())){
                            common.CExecutor.stopProgram("Repeat sample name "+line);    
                        }
                }
                        ...
                        if(line.split(":").length==2){
                                 ...
                                 if(item.equals("SAMPLE_NAME")){
                                        if(!sampleNames.contains(info)){
                                                common.CExecutor.stopProgram("SAMPLE_NAME "+ info+" should listed in [SMAPLE_LIST] section fisrt" );
                                        }else{
                ...
                if(sampleNames.size()!=0){
                        common.CExecutor.stopProgram("Do not find "+sampleNames+" in [SAMPLE_LIST]");
                }
