...
public class SampleParameter {
                        ...
                        switch (item) {
                                ...
                                case "SAMPLE.VCF" :{
                                        if(!info.contains(common.CExecutor.getFileSeparator())){
                                                info=Init.getDataDirectory()+common.CExecutor.getFileSeparator()+info;
                                        }
        ...
        private void setSequenceReadsFile(String path) {
                this.sequenceReadsFile = new file.SAM(path);
        ...
        public void setEstimatedBackgroundMutationRate(double rate) {
                ...
                common.CExecutor.println(common.CExecutor.getRunningTime()+this.getName() + " background variant frequency (BVF) " + common.NumeralHandler.setScale(rate));
        }

        public void setEstimatedHomoVCS(double sensitivity) {
                common.CExecutor.println(this.getName() + " homozygous   variant calling sensitivity (VCS): " + sensitivity);
                this.estimatedHomoVCS = sensitivity;
        }

        public void setEstimatedHeteroVCS(double sensitivity) {
                common.CExecutor.println(this.getName() + " heterozygous variant calling sensitivity (VCS): " + sensitivity + '\n');
                this.estimatedHeteroVCS = sensitivity;
        }

        public double getHomoVCSEstimated() {
                return common.NumeralHandler.setScale(this.estimatedHomoVCS);
        }

        public double getHeteroVCSEstimated() {
                return common.NumeralHandler.setScale(this.estimatedHeteroVCS);
        }
        public double getFalseIgnoracneRate(){
                return common.NumeralHandler.setScale((1-(1-this.studyFIR)*(1-this.functionalFIR)));
        }
        public double getHomoVariantDetectionSensitivity(){
                if(this.specifyHomoVDS!=0){
                       return common.NumeralHandler.setScale(this.specifyHomoVDS);
                }
                return common.NumeralHandler.setScale(this.getHomoVCSEstimated()*(1-this.studyFIR)*(1-this.functionalFIR));
        }
        public double getHeteroVariantDetectionSensitivity(){
                if(this.specifyHeteroVDS!=0){
                       return common.NumeralHandler.setScale(this.specifyHeteroVDS);
                }
                return common.NumeralHandler.setScale(this.getHeteroVCSEstimated()*(1-this.studyFIR)*(1-this.functionalFIR));
        }    
        ...
        public double getBackgroundMutationFrequencyNoConsiderSpeficyOrEstimate() {
                if(this.specifiedBackgroundMutationRate!=0){
                        return common.NumeralHandler.setScale(this.specifiedBackgroundMutationRate);
                }
                if(this.estimatedBackgroundMuationFreqency!=0){
                        return common.NumeralHandler.setScale(this.estimatedBackgroundMuationFreqency);
                }
                return 0;
        }
        ...
        public double getFalseIgnoranceRateOfFunction(){
                return common.NumeralHandler.setScale(this.functionalFIR);
        }
        public double getFalseIgnoranceRateOfStudy(){
                return common.NumeralHandler.setScale(this.studyFIR);
        }
