...
public class GIPSJob {
        ...
        public void setSampleParameterBag(SampleParameterBag sampleParameterBag) throws IOException{
                ...
                if(this.update){
                        this.updateSampleForIterating(Init.getWorkingDirectroy()+common.CExecutor.getFileSeparator()+Config.getItem("RESULT_GIPS_FILE"));
                }
        }
        ...
        public String getMD5(){
                if(this.md5==null){
                        ...
                        this.md5=stringSecurity.string2MD5(String.valueOf(this.sampleParameterBag)+String.valueOf(globalParameter)+common.CExecutor.getCurrentTime());
                }
                return this.md5;
        }
...
//                                + "\nGenome version listed in: snpeff.sourceforge.net/download.html#dblist\n");
                ...
                if(GlobalParameter.getGenomeVersion()==null){
                        common.CExecutor.stopProgram("Please set a SnpEff supportive  genome version  in "+Init.getParameterFilePath()
                ...
                if(this.jobType.equals("gips")&&(GlobalParameter.getHomoSapiensGenomeGffFile()==null)){
                        common.CExecutor.stopProgram("Please set HUMAN_GRCH37_ANNOTATION.GFF"
...
//                        common.CExecutor.println("Set HUMAN_GRCH37_ANNOTATION.GFF variable in "+Init.getParameterFilePath()+" :Done");
                ...
                if((this.jobType.equals("vcs")||this.jobType.equals("gips"))&&GlobalParameter.getSampleGffFile()==null){
                        common.CExecutor.stopProgram("Please set GFF file path for "+GlobalParameter.getGenomeVersion()+'\n');
                }
                if(this.sampleParameterBag.getSampleNumber()==0){
                        common.CExecutor.stopProgram("No sample in "+Init.getParameterFilePath());
                }
                for(SampleParameter sampleParameter:this.sampleParameterBag.getBag()){
                        if(sampleParameter.getVCFFile()==null){
                                common.CExecutor.stopProgram("Please set SAMPLE.VCF variable in "+sampleParameter.getName()+" specific [SAMPLE] setion");
                        }
                        if(this.jobType.equals("filter")){
                                ...
                                if(s1!=0||s2!=0){
                                       if(sampleParameter.getSequenceReadsFile()==null){
                                              common.CExecutor.stopProgram("Please set READS_ALIGNMENT.SAM variable in "+sampleParameter.getName()+" specific [SAMPLE] setion");
                                       }
                                       if(sampleParameter.getCallerScript()==null){
                                              common.CExecutor.stopProgram("No caller script."
