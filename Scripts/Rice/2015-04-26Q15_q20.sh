...
/path/to/samtools mpileup -ugf /path/to/all.chrs.con.fa /path/to/Rice/Working/temporary/bt_markdup.bam -go -| /path/to/bcftools call -vmO z  -Q 15 -q 20 -o - | /path/to/bcftools filter -O v -o "$2" -
